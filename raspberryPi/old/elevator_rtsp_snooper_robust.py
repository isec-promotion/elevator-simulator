...
# -*- coding: utf-8 -*-
"""
エレベーター信号スヌーピング＆RTSP映像配信システム（自動復帰機能付き）
...
class SerialSnooper:
    ...
    def initialize(self):
        """初期化"""
        logger.info("📡 シリアルスヌーピング初期化（自動復帰機能付き）")
    ...
    def start_snooping(self):
        ...
        logger.info("🔍 シリアル信号スヌーピング開始（自動復帰機能付き）")
        self.running = True
...
def main():
    ...
    parser = argparse.ArgumentParser(description='エレベーター信号スヌーピング＆RTSP映像配信システム（自動復帰機能付き）')
    ...
    # システム初期化
    logger.info("🏢 エレベーター信号スヌーピング＆RTSP映像配信システム起動（自動復帰機能付き）")
